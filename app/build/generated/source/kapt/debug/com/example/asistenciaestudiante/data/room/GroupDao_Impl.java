...
public final class GroupDao_Impl implements GroupDao {
  ...
  public GroupDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfGroupEntity = new EntityInsertionAdapter<GroupEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `groups` (`id`,`name`) VALUES (?,?)";
      }
  ...
  @Override
  public Object getAllGroups(final Continuation<? super List<GroupEntity>> $completion) {
      ...
      public List<GroupEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new GroupEntity(_tmpId,_tmpName);
            _result.add(_item);
          }
          return _result;
        } finally {
